...
from CCXT.CCXT_functions_mine import get_history_df_of_pairs_on_list
...
class PortfolioAllocationParity:
    def main(self,
             ...
             period: int,
             API: dict):
        pairs_history_df_list = get_history_df_of_pairs_on_list(pairs_list=pairs_list, timeframe=timeframe,
