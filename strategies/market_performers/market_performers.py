...
from ext_librariers.CCXT.functions_base import get_pairs_prices
from ext_librariers.CCXT.functions_mine import get_full_history_for_pairs_list, select_exchange_mode
