...
async def accinit():
    ...
    await drift_acct.initialize_user_account_and_deposit_collateral(amount=3000000, collateral_account_public_key="FHL6i18MNUoLhsMqwUFQfQLyVQy4R1jhzxG95NeKBkec")
