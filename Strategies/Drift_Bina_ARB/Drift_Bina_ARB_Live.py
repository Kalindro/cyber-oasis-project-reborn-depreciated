    ...
    async def run_constant_parallel_logic(self):
        ...
        while True:
            try:
                ...
                print("TU?")
                partial_logic_orders_execute = functools.partial(func=self.logic_orders_execute, args=(fresh_data, balances_dict,
                                                                 positions_dataframe, precisions_dataframe, API_drift, API_binance))
